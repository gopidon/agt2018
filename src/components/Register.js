...
class RegistrationForm extends React.Component {
    state = {
        ...
        spouseEmploymentCertificateFile: null,
        childAcademicCertificateFile: null,
        otherCertificateFile: null
    };
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                let variables = {employeeId, batch, name, designation, dob, currentPosting, option1, option2, option3, option4, option5, grounds, details}
                ...
                this.props.mutate({variables})
                    .then((res) => {
                        ...
                        message.success("Your representation has been uploaded. Your representation shall be frozen on the last date at 11.59 PM. However, you can modify your options/ grounds of representation before last date", 10)
...
const createRepresentationMutation = gql`
  mutation createRepresentation($employeeId: Int!, $batch: Int!, $name: String!, $designation: String!, $dob: DateTime!, $currentPosting: String!, 
    ...
    createRepresentation(employeeId: $employeeId, batch: $batch, name: $name, designation: $designation, dob: $dob, currentPosting: $currentPosting, 
...
export default graphql(createRepresentationMutation)(WrappedRegistrationForm)